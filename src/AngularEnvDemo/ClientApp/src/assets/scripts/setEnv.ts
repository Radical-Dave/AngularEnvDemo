...
const environmentFileContent = `
  ...
  export const environment = {
    ...
    env_demo_key: "${process.env.ENV_DEMO_KEY ? process.env.ENV_DEMO_KEY : 'env_demo_key_default'}",
    env_demo_name: "${process.env.ENV_DEMO_NAME}",
    env_demo_url: "${process.env.ENV_DEMO_URL}"
  };
`;
